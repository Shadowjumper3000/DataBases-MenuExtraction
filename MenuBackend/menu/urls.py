...
urlpatterns = [
    ...
    path("filter-food-items/", views.filter_foods, name="filter_foods"),  # Filter food items
    ...
    path("menu/<int:menu_id>/", views.menu_detail, name="menu_detail"),  # Menu detail
    path("restaurants/<int:restaurant_id>/past-menus/", views.past_menus, name="past_menus"),  # Past menus
]

...
urlpatterns = [
    ...
    path(
        "reports/food-item-restrictions/",
        views.food_item_restriction_report,
        name="food_item_restriction_report",
    ),  # Food item restriction report
    path(
        "reports/processing-logs/",
        views.processing_log_report,
        name="processing_log_report",
